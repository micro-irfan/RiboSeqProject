...
# Read the Excel file
# PRJNA552552_remapped
# PRJNA544411 PRJNA51553 PRJNA604580 PRJNA552552
# PRJNA812862 PRJNA375080 PRJNA756018 PRJNA507253

sample_name <- "PRJNA544411"
...
file_name <- paste(sample_name, 'STAR.mapping.png', sep = ".")
