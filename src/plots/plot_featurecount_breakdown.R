...
columns = c("sample",
            "exons_unassigned_nofeatures",
            "exons_unassigned_ambiguity",
            # "exons_unassigned_multimapping",
            "exons")
...
columns_colour <- c( 
  "exons" = "#FF0000", 
  "exons_unassigned_multimapping" = "#FF6633", 
  "exons_unassigned_ambiguity" = "#FF9999",
  "exons_unassigned_nofeatures" = "#FFCCCC"
)
...
file_name <- paste0(accession_number, ".featureCount.exons.png")
